$(document).ready(function() {
    ...
    $("#devLeadSampleInput").on("click", function() {
        ...
        $("[name='lead[latitude_degree]']").val('20');
        $("[name='lead[latitude_minute]']").val('59');
        $("[name='lead[latitude_second]']").val('59');
        $("[name='lead[latitude_cardinal]']").val('N');
        $("[name='lead[longitude_degree]']").val('145');
        $("[name='lead[longitude_minute]']").val('59');
        $("[name='lead[longitude_second]']").val('59');
