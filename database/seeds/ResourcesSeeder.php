...
class ResourcesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $leads = DB::connection('oldrps')->table('rsc_lead as ld')
            ...
            ->select(
                ...
                DB::raw("IF (EXISTS(SELECT 1 FROM rsc_lead_2d WHERE lead_id = ld.lead_id), 'Yes', 'No') as s2_data"),
                ...
                DB::raw("IF (EXISTS(SELECT 1 FROM rsc_lead_geological WHERE lead_id = ld.lead_id), 'Yes', 'No') as geo_data"),
                ...
                DB::raw("IF (EXISTS(SELECT 1 FROM rsc_lead_geochemistry WHERE lead_id = ld.lead_id), 'Yes', 'No') as chem_data"),
                ...
                DB::raw("IF (EXISTS(SELECT 1 FROM rsc_lead_gravity WHERE lead_id = ld.lead_id), 'Yes', 'No') as grav_data"),
                ...
                DB::raw("IF (EXISTS(SELECT 1 FROM rsc_lead_electromagnetic WHERE lead_id = ld.lead_id), 'Yes', 'No') as elec_data"),
                ...
                DB::raw("IF (EXISTS(SELECT 1 FROM rsc_lead_resistivity WHERE lead_id = ld.lead_id), 'Yes', 'No') as resi_data"),
                ...
                'resi.lsrt_range_penetration as resi_penetrate',
                'resi.lsrt_spacing_interval as resi_recorder',
                DB::raw("IF (EXISTS(SELECT 1 FROM rsc_lead_other WHERE lead_id = ld.lead_id), 'Yes', 'No') as oter_data"),
        ...
        foreach ($leads as $lead) {
            ...
            DB::table('lead')->insert([
                ...
                'resi_penetrate' => $lead->resi_penetrate,
                'resi_recorder' => $lead->resi_recorder,
                'oter_data' => $lead->oter_data,
    ...
    public function prospectSurveySave($data)
    {
        $surveyId = DB::table('prospect_survey')->insertGetId([
            ...
            'resi_penetrate' => $data->resi_penetrate,
            'resi_recorder' => $data->resi_recorder,

            'oter_data' => $data->oter_data,
    ...
    {
        return $resources->addSelect(
            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_seismic_3d WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as s3_data"),
            ...
            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_seismic_2d WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as s2_data"),
            ...
            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_geological WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as geo_data"),
            ...
            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_geochemistry WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as chem_data"),
            ...
            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_gravity WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as grav_data"),
            ...
            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_electromagnetic WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as elec_data"),
            ...
            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_resistivity WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as resi_data"),
            ...
            'resi.rst_depth_range as resi_penetrate',
            'resi.rst_spacing_interval as resi_recorder',

            DB::raw("IF (EXISTS(SELECT 1 FROM rsc_other WHERE prospect_id = pr.prospect_id), 'Yes', 'No') as oter_data"),
